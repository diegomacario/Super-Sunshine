...
In the case of a triangle, it is created as follows:
 ...
 ```
Where:
- *__maxverts__* is the command used to define the maximum number of vertices (*__max__*) that can be used in a scene description.
...
I think there are three visual effects that stand out in these two experiments:
