...
Description:
   ...
   It provides a function for finding the nearest intersection for a particular ray by iterating over all the objects in the scene. Note that this function
